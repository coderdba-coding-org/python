...
pcorr01.py --xfile ${file1}.noNull --yfile ${file2}.noNull
...
# SYNTAX
#exec > $logfile 2>> $logfile
#pcorr01.py --xfile $folder/datadbrt.txt --yfile $folder/datasqlexec1.txt
#pcorr01.py --xfile $folder/datalogsync.txt --yfile $folder/datasqlexec1.txt
#pcorr01.py --xfile $folder/datacellread.txt --yfile $folder/datasqlexec1.txt
#pcorr01.py --xfile $folder/dataprocesslimit.txt --yfile $folder/datasqlexec1.txt
#pcorr01.py --xfile $folder/databufferhit.txt --yfile $folder/datasqlexec1.txt
